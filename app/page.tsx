    ...
    <main className="min-h-screen bg-[#07090d] text-white">
      <div className="flex min-h-screen">
        ...
        {mobileMenuOpen && (
          ...
          >
            <aside
              className="h-full w-72 border-r border-white/10 bg-[#0a0d12] p-5 shadow-2xl"
            ...
            >
              <div className="mb-8 flex items-center justify-between">
                ...
                <button
                  onClick={closeMobileMenu}
                  className="flex h-9 w-9 items-center justify-center rounded-xl border border-white/10 bg-white/5 text-gray-400 hover:bg-white/10 hover:text-white"
        ...
        <section className="min-w-0 flex-1">
          ...
          {/* MOBILE HEADER */}
          <header className="border-b border-white/10 bg-[#07090d]/95 px-4 py-4 backdrop-blur md:hidden">
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                className="flex h-10 w-10 items-center justify-center rounded-xl border border-white/10 bg-white/5 text-lg text-gray-300 hover:bg-white/10 hover:text-white"
          ...
          {/* DESKTOP PAGE HEADER */}
          <header className="hidden border-b border-white/10 px-6 py-5 md:block md:px-10">
          ...
          <div className="p-4 sm:p-6 md:p-10">
            ...
            {/* COMMAND CENTER */}
            <div className="rounded-3xl border border-white/10 bg-white/[0.04] p-5 sm:p-6 md:p-8">
              <div className="mb-6">
              ...
              <div className="mt-4 flex justify-end">
                <button
                  onClick={addTask}
                  className="w-full rounded-xl bg-white px-5 py-3 text-sm font-semibold text-black hover:bg-gray-200 sm:w-auto"
                >
                  Start Task →
                </button>
              </div>
            ...
            <div className="mt-6 grid gap-4 sm:grid-cols-3">
              ...
              <Stat
                title="System"
                value="Online"
                subtitle="Everything is running"
              />
            </div>
            ...
            <div className="mt-10">
              <div className="flex items-end justify-between gap-4">
                ...
                <Link
                  href="/team"
                  className="shrink-0 text-sm text-gray-500 hover:text-white"
                >
                  View team →
                </Link>
              </div>
                ...
                {tasks.slice(0, 4).map((item, index) => (
                  ...
                  >
                    <div className="flex min-w-0 items-center gap-4">
                      <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-xl bg-white/5 text-xs text-gray-400">
